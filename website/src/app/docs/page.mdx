...
This command creates a `.idomaticrc.json` configuration file tailored to your tech stack (React, HTML, Vue, etc).
...
Idomatic uses a `.idomaticrc.json` config file to customize how and where IDs are applied.

### Example `.idomaticrc.json`
